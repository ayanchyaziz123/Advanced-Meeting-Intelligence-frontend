              ...
              <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                ...
                <div className="relative">
                  ...
                  <div className="ml-16">
                    ...
                    <p className="mt-2 text-base text-gray-500">
                      Automatically record meetings from popular video conferencing platforms with crystal-clear quality.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="ml-16">
                    ...
                    <p className="mt-2 text-base text-gray-500">
                      Works seamlessly with all major video conferencing platforms for a unified meeting experience.
                    </p>
                  </div>
                </div>
              </div>
